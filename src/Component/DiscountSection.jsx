...
function DiscountSection() {
    return (
        <div className="grid grid-cols-3" >
            ...
            <div className="">
                <h1 className="mt-40 text-2xl uppercase ">Super <span className="text-[#BB8493] text-base">Saving </span></h1>
                <p className="text-[#BB8493] text-lg">Sale Up to 40% off +12 months Financing</p>
